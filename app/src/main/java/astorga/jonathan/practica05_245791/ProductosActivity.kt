            ...
            "ANTOJITOS"-> {
                menu.add(
                    Product(
                        ...
                        "Rellenas con su carne favorita, servidas con ensalada - Filled" +
                                " with your choice of meat, served with salad",
                        5.99
                    )
                )
                menu.add(
                ...
                menu.add(
                    Product(
                        "Sopes",
                        R.drawable.sopes,
                        "Tortilla gruesa cubierta de frijoles, tu carne favorita, lechuga, queso " +
                                "fresco y crema - Fried thick tortilla with beans, your choice of meat, lettuce, fresh cheese, and sour cream.",
                        3.79
                    )
                )
                menu.add(
                    Product(
                        ...
                        "Tortilla frita con frijoles, tu carne favorita, lechuga, " +
                                "queso fresco, crema y jitomate - Fried tortilla with beans, your choice of meat, lettuce, fresh cheese, sour cream and " +
                                "tomatoes.",
                        4.59
                    )
                )
